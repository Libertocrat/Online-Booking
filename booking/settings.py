...
SECRET_KEY = 'django-insecure-d_+9qdc480p23#-xhj8h()=jdrpn3g8szq_1cz+kl=2gg-=+mi'
...
# Serve static files from "./static", where compiled front-end files will be saved by webpack
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
